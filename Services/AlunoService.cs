...
public static class AlunoService
{
        ...
        static AlunoService()
        {
            Alunos = new List<Aluno>
            {
                ...
                new Aluno { Id = 1, Nome = "Bia", Email="teste@example.com", Senha="teste2", Nascimento="01/01/2000", Cpf="000000000-11", Telefone="(31)94000-0000", Ra= 320137870, Faculdade="Una", Curso="Psicologia", Instituicao1="Ulisboa", Instituicao2="Eduportugal"}
            };
        }
